...
const (
	...
	LEFT_PARENTESIS_DELIMITER  = "("
	RIGHT_PARENTESIS_DELIMITER = ")"
...
var (
	...
	ENDIF_TOKEN = &Token{Type: ENDIF_KEYWORD}
	VAR_TOKEN   = &Token{Type: VAR_KEYWORD}
	EXEC_TOKEN  = &Token{Type: EXEC_KEYWORD}

	LEFT_PARENTESIS_TOKEN       = &Token{Type: LEFT_PARENTESIS_DELIMITER}
	RIGHT_PARENTESIS_TOKEN      = &Token{Type: RIGHT_PARENTESIS_DELIMITER}
	...
	tokensArray = map[string]*Token{
		...
		LEFT_PARENTESIS_DELIMITER:  LEFT_PARENTESIS_TOKEN,
		RIGHT_PARENTESIS_DELIMITER: RIGHT_PARENTESIS_TOKEN,
